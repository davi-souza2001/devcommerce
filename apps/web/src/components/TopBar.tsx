...
export function TopBar() {
	return (
		<div className="h-20 w-full flex items-center justify-around bg-black text-slate-200 text-xl font-regular uppercase transition-all">
			<span className="cursor-pointer opacity-80 transition-all hover:opacity-100">Home</span>
			...
			<span className="cursor-pointer opacity-80 transition-all hover:opacity-100">Account</span>
		</div>
	)
}
