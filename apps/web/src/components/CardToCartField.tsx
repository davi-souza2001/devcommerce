...
export function CardToCartField(props: CardToCartFieldProps) {
	...
	return (
		<div className="lg:w-[900px] md:w-[750px] h-36 w-[550px] flex items-center justify-between bg-slate-300 mb-5 rounded-tl-md rounded-bl-md rounded-tr-md rounded-br-md">
